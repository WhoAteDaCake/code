...
classes: $(SRCDIR)/uk/ac/nott/cs/g53dia/multisimulator/*.java
...
docs: $(SRCDIR)/uk/ac/nott/cs/g53dia/multiagent/*.java
	...
	@javadoc $(SRCDIR)/uk/ac/nott/cs/g53dia/multiagent/*.java  $(SRCDIR)/uk/ac/nott/cs/g53dia/multilibrary/*.java   $(SRCDIR)/uk/ac/nott/cs/g53dia/simulator/*.java -d $(DOCDIR) -private >/dev/null
	@echo "done."
